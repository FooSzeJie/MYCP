...
import 'package:client/screens/Home%20Page/user_home_screen.dart';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['token'] != null && data['userId'] != null) {
          ...
          if (data['role'] == "admin" || data['role'] == "traffic warden") {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => UserHomePage(userId: userId)), // Pass userId to HomePage
            );
          }
